...
<html lang="en">
  ...
  <body>
          ...
          <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
              ...
              <div class="carousel-caption text-left">
                <h2 class="wow fadeInRight" data-wow-delay="0.2s">You think it. We do it.</h2>
                <h3 class="wow fadeInRight" data-wow-delay="0.4s">Brand your business like the pros.</h4>
                <a href="home.php" class="btn btn-lg btn-common btn-effect wow fadeInRight" data-wow-delay="0.9s">Get Started Now!</a>
                <a href="#" class="btn btn-lg btn-border wow fadeInRight" data-wow-delay="1.2s">See How It Works</a>
              </div>
            </div>
          </div>
        </div>
    ...
    <section id="features" class="section" style="background:#eee">
      <div class="container">
        <div class="section-header">
          <h2 class="section-titles">High Quality Creative Designs</h2>
          <p class="section-subtitles">Here's why 1m+ businesses have chosen Xamon Eye:</p>
        </div>
        <div class="row">
          <!-- Start featured -->
          <div class="col-lg-6 col-md-6 col-xs-12">
            <div class="featured-box">
              ...
              <div class="featured-content">
                ...
                <p>Just share your idea with us and we do the rest.</p>
              </div>
            </div>
          </div>
          <!-- End featured -->
          ...
          <div class="col-lg-6 col-md-6 col-xs-12">
            <div class="featured-box">
              ...
              <div class="featured-content">
                ...
                <h4>Own Your Design</h4>
                <p>No need for licensing fee. You own your brand's work.</p>
              </div>
            </div>
          </div>
          <!-- End featured -->
          ...
          <div class="col-lg-6 col-md-6 col-xs-12">
            <div class="featured-box">
              ...
              <div class="featured-content">
                ...
                <p>Get the perfect design, or your money back.</p>
              </div>
            </div>
          </div>
          <!-- End featured -->
          ...
          <div class="col-lg-6 col-md-6 col-xs-12">
            <div class="featured-box">
              ...
              <div class="featured-content">
                ...
                <p>We work closely with you to achieve your desired creative vision.</p>
              </div>
            </div>
          </div>
          <!-- End featured -->
    ...
    <!-- Portfolio Section -->
    <section id="portfolios" class="section" style="background: #343a40">
      <!-- Container Starts -->
      <div class="container">
        <div class="section-header">
    ...
    <section id="cta" class="section" data-stellar-background-ratio="0.5">
      <div class="container">
        <div class="row">
          <div class="col-lg-6 col-md-6 col-xs-12">
            <div class="cta-text">
              <h5>Still confused? Download a free lite version to get started!</h5>
            </div>
          </div>
    ...
    <section id="contact" class="section">
      <div class="contact-form">
        <div class="container">
          <div class="section-header">
            <h2 class="section-titles">Get In Touch</h2>
            <p class="section-subtitles">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dignissimos debitis.</p>
          </div>
          <div class="row">
          ...
          <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 col-mb-12">
              ...
              <div class="textwidget">
                <p>Blablajgjyg,ib ivti ktg,biuh kuguyg</p>
              </div>
              <ul class="footer-social">
                <li><a class="facebook" href="#"><i class="lni-facebook-filled"></i></a></li>
                <li><a class="twitter" href="#"><i class="lni-twitter-filled"></i></a></li>
